...
function displayTime() {
  ...
  var date = currentTime.toLocaleDateString("en-US", {
    year: "numeric",
    month: "short",
    day: "numeric"
  });
  ...
  time.textContent = "".concat(dayOfWeek, ", ").concat(date, " ").concat(hour, ":").concat(minutes);
}
...
function handleSubmit(event) {
  ...
  var cityInput = document.querySelector('input[name="q"]');
  var city = cityInput.value;
  searchCity(city);
}
function searchCity(city) {
  var apiKey = "f853d779bfd20dcdcb8c01930821455a";
